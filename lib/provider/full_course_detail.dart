...
class CourseD {
  ...
  factory CourseD.fromJson(Map<String, dynamic> json) => CourseD(
        ...
        coursofledn: json["coursofledn"] == null ||
                json["coursofledn"] == [] ||
                json["coursofledn"] == "[]"
            ? []
            : List<Coursofledn>.from(
                json["coursofledn"].map((x) => Coursofledn.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "coursofledn":
            List<Coursofledn>.from(coursofledn.map((x) => x.toJson())),
...
class Coursofledn {
  ...
  factory Coursofledn.fromJson(Map<String, dynamic> json) => Coursofledn(
        id: json["id"],
        courseId: json["course_id"],
